...
- **Client-safe**: `src/lib/core/config/environment.ts` (public variables only)
...
- **Node.js**: `src/lib/core/config/node-environment.ts` (dotenv + process.env)
- **Pattern**: Clear separation between client and server environments
