							...
							<div class="flex items-center justify-between">
								...
								<div class="flex items-center space-x-2">
									...
									<button
										...
										class="relative inline-flex items-center rounded-md border border-[rgb(218,218,221)] bg-white px-3 py-2 text-sm font-medium text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed dark:border-[#3f3f46] dark:bg-[#23232a] dark:text-gray-300 dark:hover:bg-[#2d2d35] cursor-pointer"
									>
									...
									<div class="flex items-center space-x-1">
										{#each getPageNumbers() as page}
											<button
												...
												class="relative inline-flex items-center rounded-md px-3 py-2 text-sm font-medium {page === pagination.page
													? 'bg-[rgb(37,140,244)] text-white'
													: 'border border-[rgb(218,218,221)] bg-white text-gray-500 hover:bg-gray-50 dark:border-[#3f3f46] dark:bg-[#23232a] dark:text-gray-300 dark:hover:bg-[#2d2d35]'} cursor-pointer"
											>
												{page}
											</button>
										{/each}
