...
import { getSupabaseUrl } from '../../utils/url-utils';
 ...
 * The URL will be determined at runtime by the browser.
 */
export const supabase = createClient<Database>(getSupabaseUrl(), PUBLIC_SUPABASE_ANON_KEY, {
	auth: {
