...
<div class="space-y-6">
		...
		<Card class="p-6">
			<div class="grid grid-cols-1 gap-4 md:grid-cols-6">
				...
				<div class="text-center">
					...
					<div class="text-xs {getRealtimeStatusColor()} mt-1 rounded-full px-2 py-1">
		...
		<Card class="p-6">
			...
			<div class="flex gap-2">
				...
				{#if realtimeTestResult !== null}
					<span
						class="text-sm {realtimeTestResult
							? 'text-green-600'
	...
	<!-- Controls -->
	<Card class="p-6">
		<h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">Worker Controls</h3>
			...
			<div class="w-full max-w-md rounded-lg bg-white p-6 dark:bg-gray-800">
				...
				<div class="space-y-4">
					...
					<div>
						...
						>
						<Input type="number" bind:value={config.retryAttempts} min="1" max="10" class="mt-1" />
					</div>
				...
				{#each activeWorkers as worker}
					<div class="flex items-center justify-between rounded-lg bg-gray-50 p-3 dark:bg-gray-800">
						...
						<div class="flex items-center gap-3">
							...
							{/if}
							<span
								class="rounded-full px-2 py-1 text-xs font-medium {getStatusColor(worker.status)}"
							>
								{worker.status}
							</span>
						</div>
