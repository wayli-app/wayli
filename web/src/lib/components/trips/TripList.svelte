<script lang="ts">
  ...
  import { Edit, MapPin, BarChart2, Trash2, Map, Search, ArrowUp, ArrowDown, List, LayoutGrid } from 'lucide-svelte';
...
<div class="space-y-4">
  <div class="relative">
    ...
    <input
      ...
      class="w-full rounded-md border border-[rgb(218,218,221)] bg-white py-2 pl-10 pr-4 text-sm placeholder:text-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
    />
  </div>

  <div class="rounded-lg border border-[rgb(218,218,221)] dark:border-[#23232a] bg-white dark:bg-[#23232a]">
    <table class="w-full">
      <thead>
        <tr class="border-b border-[rgb(218,218,221)] dark:border-[#23232a] bg-white dark:bg-[#23232a]">
          <th class="w-8 px-6 py-4">
            <input type="checkbox" class="rounded border-gray-300 dark:border-[#23232a]" />
          </th>
          <th class="px-6 py-4">
            <button
              class="flex items-center gap-1 text-left text-sm font-medium text-gray-900 dark:text-gray-100 hover:text-blue-600 cursor-pointer"
          ...
          <th class="px-6 py-4 text-left text-sm font-medium text-gray-900 dark:text-gray-100">Countries</th>
          <th class="w-32 px-6 py-4 text-right text-sm font-medium text-gray-900 dark:text-gray-100">Actions</th>
        </tr>
      </thead>
      <tbody>
        {#each sortedTrips as trip}
          ...
          >
            ...
            <td class="px-6 py-4 text-sm font-medium text-gray-900 dark:text-gray-100">{trip.title}</td>
            <td class="px-6 py-4">
            ...
            <td class="px-6 py-4">
              <div class="flex justify-end gap-2">
                ...
                <button class="rounded p-1 hover:bg-gray-100 cursor-pointer" aria-label="View points of interest">
                ...
                <button class="rounded p-1 hover:bg-gray-100 cursor-pointer" aria-label="View on map">
                  <Map class="h-4 w-4 text-gray-500" />
                </button>
                <button
                  class="rounded p-1 hover:bg-gray-100 text-red-500 hover:text-red-600 cursor-pointer"
                  aria-label="Delete"
  ...
  <div class="flex items-center gap-2">
    <button
      class="rounded-md border border-[rgb(218,218,221)] dark:border-[#3f3f46] bg-white dark:bg-[#23232a] p-2 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#2d2d35] cursor-pointer"
