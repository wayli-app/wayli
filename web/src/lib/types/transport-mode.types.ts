export enum TransportDetectionReason {
	...
	AIRPORT_AND_SPEED = 'Visited airport and then travelled at airplane speed',
	AIRPLANE_SPEED_ONLY = 'Speed in airplane range, likely airplane',
	...
	PHYSICALLY_IMPOSSIBLE = 'Physically impossible speed/mode combination, forced correction',
