...
describe('Validation Schemas', () => {
  describe('User Schema', () => {
    ...
    it('should reject invalid user data', () => {
      ...
      if (!result.success) {
        ...
        expect(result.error.errors[1].message).toBe('Invalid email format');
        expect(result.error.errors[2].message).toBe('Must be at least 18 years old');
      }
    });
  ...
  describe('Trip Schema', () => {
    ...
    it('should reject invalid date formats', () => {
      ...
      if (!result.success) {
        expect(result.error.errors.some(e => e.message === 'Invalid date format')).toBe(true);
      }
    });
...
describe('Data Sanitization', () => {
  ...
  describe('Object Sanitization', () => {
    it('should sanitize nested objects', () => {
      ...
      expect(result.nested.title).toBe('Test Title');
      expect(result.nested.content).toBe('alert("xss")');
    });
  });
});