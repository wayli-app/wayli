...
COMMENT ON TABLE transport_mode_state IS 'Incremental watermark for the detect-transport-mode job. last_processed_at is exclusive; the job resumes from last_processed_at - LOOKBACK (1h) to re-decode the tail of the previous segment.';
