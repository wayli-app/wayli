...
-- @fluxbase:description Returns current plan items for a specific trip, grouped by day. Use when the user asks about their itinerary or wants to modify existing plan items. Looks up trip by trip_id (preferred) or trip_title.
