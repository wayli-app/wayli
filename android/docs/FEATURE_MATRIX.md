...
| **Location tracking** | ✅ | Foreground service with persistent notification; play/gplay flavors use FusedLocationProvider + ActivityRecognition, foss flavor uses framework APIs. |
